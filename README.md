...
* Live cooldown and active-duration timers rendered right on each icon
...
* Full profile system: create, switch, and delete named profiles, or export/import a setup as a copy-paste string
* Clean, dark settings menu via **/kcd**

Built for Legion 7.3.5. No dependencies. No bloat. Just clean cooldown awareness.

**No ElvUI/SUF support yet**

![1](https://media.forgecdn.net/attachments/1753/902/screenshot-at-jun-24-15-43-37-webp.webp)

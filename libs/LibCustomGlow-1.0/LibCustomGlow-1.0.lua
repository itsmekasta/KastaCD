...
-- KastaCD-local: bumped one above upstream (20) so THIS copy always wins
-- LibStub's registration regardless of addon load order - LibCustomGlow-1.0
-- is also bundled by WeakAuras, and LibStub only keeps one shared instance
-- per major version (whichever has the highest minor version, checked at
-- registration time, not load order).
